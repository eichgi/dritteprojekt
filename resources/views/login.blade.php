...
@section('content')
    ...
    <div class="row">
        <section id="section-login" class="col-sm-6 col-sm-offset-2 col-md-6 col-md-offset-3">
    ...
    <div class="row">
        <section id="section-about" class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 well">
